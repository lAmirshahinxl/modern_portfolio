    ...
    >
      ...
      <div className="landing-project-body">
        ...
        <div className="project-card-footer">
          ...
          <a href={project.href} target="_blank" rel="noreferrer" aria-label={`View ${project.title}`}>View <span>↗</span></a>
        </div>
      </div>
    </article>
  );
  ...
  return (
    <div className="landing-shell">
      ...
      <main id="main-content">
        <ParallaxComponent className="landing-hero-parallax" id="top" labelledBy="landing-title">
          <div className="landing-hero-grid">
            <div className="landing-hero-copy">
              ...
              <h1 id="landing-title">I build software that <em>feels clear.</em></h1>
              ...
              <div className="hero-actions">
                <a className="button button-primary" href={portfolio.resume.href} download={portfolio.resume.label}>Download résumé <span>↓</span></a>
            ...
            <aside className="hero-signal-panel" aria-label="Profile snapshot">
              <span className="signal-pixel-image signal-image-placeholder" aria-hidden="true" />
        ...
        <div className="signal-marquee" role="region" aria-label="Core stack">
        ...
        <RevealSection className="landing-section intro-section" id="about" labelledBy="about-title">
          ...
          <div className="stat-ribbon" role="group" aria-label="Career highlights" data-scroll-layer data-scroll-speed="9">
        ...
        <RevealSection className="landing-section work-section" id="selected-work" labelledBy="work-title">
          ...
          <div className="project-grid" data-scroll-layer data-scroll-speed="7">
            {projects.map((project, index) => <SpotlightProject key={project.title} project={project} index={index} accent={projectAccents[index % projectAccents.length]} />)}
          </div>
        ...
        <RevealSection className="landing-section capabilities-section" id="capabilities" labelledBy="capabilities-title">
          ...
          <div className="capability-grid" data-scroll-layer data-scroll-speed="8">
            {capabilities.map((capability) => <SpotlightCapability key={capability.index} capability={capability} />)}
          </div>
        </RevealSection>
        ...
        <RevealSection className="landing-section experience-section" id="experience" labelledBy="experience-title">
          ...
          <span className="tracing-beam experience-tracing-beam" aria-hidden="true"><i /></span>
        ...
        <RevealSection className="landing-cta-section" id="contact" labelledBy="cta-title">
          ...
          <a className="button button-primary" href={`mailto:${portfolio.contact.email}`}>Start a conversation <span>↗</span></a>
