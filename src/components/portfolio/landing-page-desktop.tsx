...
import { DesktopParallaxComponent } from "@/components/portfolio/desktop-parallax-scrolling";
import { MagneticLink, PointerGlow, ScrollProgress, TextReveal, TracingBeam, useSpotlight } from "@/components/ui/motion-primitives";
import { DesktopFooter } from "@/components/portfolio/desktop-footer-section";
import { DesktopPixelImage } from "@/components/portfolio/desktop-pixel-image";
import { AnimatedStat } from "@/components/ui/animated-stat";
import { DesktopBottomDock } from "@/components/portfolio/desktop-bottom-dock";
  ...
  return (
    <div className="landing-shell" ref={landingRootRef}>
      ...
      <main id="main-content">
        <DesktopParallaxComponent className="landing-hero-parallax" id="top" labelledBy="landing-title">
